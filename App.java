...
public class App {
    // variables
    public static ArrayList<Restaurant> database = new ArrayList<Restaurant>();
    public static String a, b, c, d, e, f;

    //Methods-------------------------------------------------------------
    public void addRestaurant(Restaurant a) {
        database.add(a);
    }
...
//=============================================================================
        ...
        //In-n-Out ============================================================
        Restaurant inOut = new Restaurant("In-n-Out");
        database.add(inOut);
        ...
        //Burger King =========================================================
        Restaurant BK = new Restaurant("Burger King");
        database.add(BK);
...
//=============================================================================
        ...
        a = lowestCalRest.getRestName();
        b = lowestCalBurger.getMenuType();
        c = lowestSodRest.getRestName();
        d = lowestSodBurger.getMenuType();
        e = lowestFatRest.getRestName();
        f = lowestFatburger.getMenuType();

        String[][] output = {
                { "Calories (Cal)", lowestCalRest.getRestName(), "" + calorieCount },
                { "Fat (g)", lowestFatRest.getRestName(), "" + fatCount },
                { "Sodium (g)", lowestSodRest.getRestName(), "" + sodiumCount},
        };

//        System.out.println("The lowest: 		Restaurants    Burger     Calories");
